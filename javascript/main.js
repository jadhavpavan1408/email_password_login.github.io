// bookbtn in navbar 
function bookbtnmouseover(){
  document.getElementById("bookbtn").className = "btn btn-success rounded rounded-pill pe-4 ps-4";
}
function bookbtnmouseout(){
  document.getElementById("bookbtn").className = "btn btn-warning rounded rounded-pill pe-4 ps-4";
}
// Serach City1 
var fromplaces = [
    "Select City",
  ...
  punjab = ["Golden Temple", "Khalasa College"];
  ...
  function SubmitClick() {
    ...
    document.getElementById("ticketicon").className =
      ...
      document.getElementById("ticketicon2").className =
      "bi bi-trash";
    document.getElementById("ticketicon").style.color = "green";
  }
  function trashiconclick(){
    document.querySelector("#ticketprint").style.display = "none";
  }